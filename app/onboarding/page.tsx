...
export default function OnboardingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: Store firstName, lastName, interests in user metadata or separate table
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.inputGroup}>
              ...
              <input
                ...
                placeholder="products@nicelydone.club"
                required
              />
            </div>
            ...
            {/* Password */}
            <div className={styles.inputGroup}>
              <label className={styles.label}>Choose a password (required)</label>
              <input
                type="password"
            ...
            <div className={styles.checkboxGroup}>
              <label className={styles.label}>Products you&apos;re interested in</label>
              <div className={styles.checkboxList}>
                <label className={styles.checkboxItem}>
                  <input
                    type="checkbox"
                    checked={formData.interests.includes('notes')}
                    onChange={() => handleCheckboxChange('notes')}
                  />
                  <span>Voice Notes & Journaling</span>
                </label>
                <label className={styles.checkboxItem}>
                  <input
                    type="checkbox"
                    checked={formData.interests.includes('patterns')}
                    onChange={() => handleCheckboxChange('patterns')}
                  />
                ...
                <label className={styles.checkboxItem}>
                  <input
                    type="checkbox"
                    checked={formData.interests.includes('dreams')}
                    onChange={() => handleCheckboxChange('dreams')}
                  />
                  <span>Dream Analysis</span>
                </label>
              </div>
              <p className={styles.disclaimer}>Don&apos;t worry, this is not a commitment to any product.</p>
            </div>
